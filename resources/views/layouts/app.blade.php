...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    <head>
        ...
        <title>{{ config('app.name', 'TeoriWarna') }} - Professional Art Supply</title>
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                        ...
                        <div class="md:col-span-2">
                            <div class="text-2xl font-black font-heading text-white mb-3">
                                teoriwarna
                            </div>
                                ...
                                @auth
                                    ...
                                    <li>
                                        <form method="POST" action="{{ route('logout') }}" class="inline">
                                            @csrf
                                            <button type="submit" class="text-gray-400 hover:text-primary-500 transition-colors text-sm">Logout</button>
                                        </form>
                                    </li>
                                @else
