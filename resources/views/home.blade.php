...
<head>
    ...
    <title>{{ config('app.name', 'TeoriWarna') }} - Premium Art Supply</title>
...
<body class="bg-gray-950 text-gray-100 antialiased">
    <!-- Navigation -->
    <nav class="bg-gray-900 border-b border-gray-800 sticky top-0 z-50 backdrop-blur-sm bg-gray-900/95">
                ...
                <div class="flex items-center gap-4">
                    @auth
                        @if(auth()->user()->hasAdminAccess())
                            <a href="{{ url('/admin') }}" class="px-4 py-2 text-sm font-medium text-gray-300 hover:text-white hover:bg-gray-800 rounded-lg transition-colors">
                                Admin Panel
                            </a>
                        @endif
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24 lg:pt-32 lg:pb-32">
            <div class="text-center">
                ...
                <div class="inline-flex items-center gap-2 px-4 py-2 bg-primary-500/10 border border-primary-500/20 rounded-full mb-8">
                    ...
                    <span class="text-primary-400 text-sm font-medium">Premium Art Supply Collection</span>
                </div>

                <!-- Main Heading -->
                <h1 class="text-5xl md:text-6xl lg:text-7xl font-black font-heading mb-6 text-white">
                    teoriwarna
                </h1>
                ...
                <p class="text-base md:text-lg text-gray-400 mb-12 max-w-2xl mx-auto">
                    Premium art supply e-commerce bringing you the latest in quality and creativity. Express yourself through color.
                </p>
    ...
    <!-- Features Section -->
    <section class="bg-gray-900 border-y border-gray-800 py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <!-- Feature 1 -->
                <div class="bg-gray-800 border border-gray-700 rounded-lg p-8 hover:border-primary-500/50 transition-all">
                    <div class="w-12 h-12 bg-primary-500/10 border border-primary-500/20 rounded-lg flex items-center justify-center mb-6">
                    ...
                    <p class="text-gray-400">Explore our entire product catalog without needing to create an account. Shop at your own pace.</p>
                </div>
                ...
                <div class="bg-gray-800 border border-gray-700 rounded-lg p-8 hover:border-primary-500/50 transition-all">
                    ...
                    <p class="text-gray-400">Create an account to track orders, save favorites, and get personalized recommendations tailored to you.</p>
                </div>
                ...
                <div class="bg-gray-800 border border-gray-700 rounded-lg p-8 hover:border-primary-500/50 transition-all">
                    ...
                    <p class="text-gray-400">Shop with confidence using our secure payment system and comprehensive order management.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                ...
                <div class="md:col-span-2">
                    <div class="flex items-center gap-2 mb-3">
                        ...
                        <span class="text-2xl font-black font-heading text-white">teoriwarna<span class="text-primary-500">.shop</span></span>
                    </div>
                    <p class="text-gray-400 text-sm mb-4 max-w-md">
                        Your premier destination for art supply.
                    </p>
                    <div class="flex gap-4">
                        <a href="#" class="w-10 h-10 bg-gray-800 hover:bg-primary-600 hover:text-white text-gray-400 rounded-full flex items-center justify-center transition-colors">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        @auth
                            <li><a href="{{ route('profile.edit') }}" class="text-gray-400 hover:text-primary-500 transition-colors text-sm">My Profile</a></li>
                            <li><a href="{{ route('orders.index') }}" class="text-gray-400 hover:text-primary-500 transition-colors text-sm">My Orders</a></li>
                        @else
                            <li><a href="{{ route('login') }}" class="text-gray-400 hover:text-primary-500 transition-colors text-sm">Login</a></li>
                            <li><a href="{{ route('register') }}" class="text-gray-400 hover:text-primary-500 transition-colors text-sm">Register</a></li>
                        @endauth
                    </ul>
                </div>
            </div>
