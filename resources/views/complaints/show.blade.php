                ...
                <div class="p-6">
                    ...
                    <div class="border-t pt-4">
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            ...
                            <div>
                                <p class="text-sm font-medium text-gray-500">Alasan Komplain</p>
                        ...
                        @if($complaint->hasReply())
                            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-4">
                                <div class="flex justify-between items-start mb-2">
                                    <h4 class="font-semibold text-gray-900">Balasan Admin</h4>
                                    <p class="text-xs text-gray-500">{{ $complaint->admin->name ?? 'Admin' }}</p>
                                </div>
                                <p class="text-gray-700 whitespace-pre-wrap">{{ $complaint->admin_reply }}</p>
                            </div>
                        @else
                            <div class="bg-gray-50 border border-gray-200 rounded-lg p-4 mt-4">
                                <p class="text-gray-500 text-center">Menunggu balasan dari admin...</p>
                            </div>
                        @endif
